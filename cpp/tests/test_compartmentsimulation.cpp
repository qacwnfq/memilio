...
//
//    Eigen::MatrixXd actual_noise_correlation = mio::compute_noise_correlation(time_point, model, sim);
//    ASSERT_TRUE(actual_noise_correlation.isApprox(expected_noise_correlation));
//}
